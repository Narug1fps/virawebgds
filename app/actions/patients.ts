...
export async function createPatient(patientData: {
  ...
  await createNotification("Paciente Adicionado", `${patientData.name} foi adicionado com sucesso.`, "success")
...
export async function updatePatient(
  ...
  await createNotification("Paciente Atualizado", `${patientData.name} foi atualizado com sucesso.`, "info")
